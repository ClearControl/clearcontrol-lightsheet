...
/**
 * ChangeLightSheetHeightInstruction allows controlling the scan head to change the height of light sheets
 *
...
public class ChangeLightSheetHeightInstruction extends LightSheetMicroscopeInstructionBase {
    ...
    public ChangeLightSheetHeightInstruction(LightSheetMicroscope pLightSheetMicroscope, int pLightSheetIndex, double pLightSheetHeight) {
        super("Adaptation: Change light sheet height to " + pLightSheetHeight, pLightSheetMicroscope);
