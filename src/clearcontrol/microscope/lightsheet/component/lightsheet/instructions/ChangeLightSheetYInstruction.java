...
/**
 * ChangeLightSheetYInstruction allows controlling the scan head to change the Y position of light sheets
 *
 * Author: @haesleinhuepf
 * July 2018
 */
public class ChangeLightSheetYInstruction extends LightSheetMicroscopeInstructionBase {
    ...
    public ChangeLightSheetYInstruction(LightSheetMicroscope pLightSheetMicroscope, int pLightSheetIndex, double pLightSheetY) {
        super("Adaptation: Change light sheet Y to " + pLightSheetY, pLightSheetMicroscope);
