...
/**
 * ChangeLightSheetXInstruction allows controlling the scan head to change the X position of light sheets
 *
 * Author: @haesleinhuepf
 * July 2018
 */
public class ChangeLightSheetXInstruction extends LightSheetMicroscopeInstructionBase {
    ...
    public ChangeLightSheetXInstruction(LightSheetMicroscope pLightSheetMicroscope, int pLightSheetIndex, double pLightSheetX) {
        super("Adaptation: Change light sheet X to " + pLightSheetX, pLightSheetMicroscope);
