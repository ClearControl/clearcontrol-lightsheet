...
/**
 * The MakeMirrorFlatInstruction sends an array of zeros to the deformable
 * mirror device in order to give it a flat shape.
 *
 * Author: @haesleinhuepf July 2018
 */
public class MakeMirrorFlatInstruction extends InstructionBase
                                       implements LoggingFeature
{
  ...
  {
    super("Adaptive optics: Send flat mode to "
