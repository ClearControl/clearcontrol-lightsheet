...
/**
 * The ZernikeGeneticAlgorithmDemo sets a certain combination of Zernike modes
...
public class ZernikeGeneticAlgorithmDemo
{
  public static void main(String... args)
  {
    ...
    { 1.0, -0.5, 0.25, 0.125, -0.0625, 0 };
    ZernikeDemoSolution lReferenceSolution =
                                           new ZernikeDemoSolution(lReferenceFactors,
                                                                   null,
                                                                   lDMSimulator,
                                                                   160,
                                                                   null);
    ...
    ZernikeDemoSolutionFactory lSolutionFactory =
                                                new ZernikeDemoSolutionFactory(null,
                                                                               lDMSimulator,
                                                                               160,
                                                                               6,
                                                                               1.0,
    ...
    Population<ZernikeDemoSolution> lInitialPopulation =
                                                       new Population<ZernikeDemoSolution>(lSolutionFactory,
                                                                                           100,
                                                                                           1);
    ...
    System.out.println("Best solution: "
                       + Arrays.toString(lSolution.getFactors()));
    System.out.println("Ground truth:  "
                       + Arrays.toString(lReferenceSolution.getFactors()));
