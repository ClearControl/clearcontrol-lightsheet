...
/**
 * The ZernikeDemoSolutionFactory allows to create ZernikeDemoSolutions which
 * don't need a real microscope to calculate fitness.
 *
 * Author: @haesleinhuepf 04 2018
 */
public class ZernikeDemoSolutionFactory implements
                                        SolutionFactory<ZernikeDemoSolution>
{
  ...
  public ZernikeDemoSolutionFactory(LightSheetMicroscope pLightSheetMicroscope,
                                    SpatialPhaseModulatorDeviceInterface pSpatialPhaseModulatorDeviceInterface,
                                    double pPositionZ,
                                    int pZernikeCount,
                                    double pRangeFactor,
                                    DenseMatrix64F pReferenceMatrix)
  {

    mFactory =
             new ZernikeSolutionFactory(pLightSheetMicroscope,
  ...
  public ZernikeDemoSolution random()
  {
    ...
    return new ZernikeDemoSolution(lSolution.mFactors,
  ...
  @Override
  public ZernikeDemoSolution crossover(ZernikeDemoSolution pSolution1,
                                       ZernikeDemoSolution pSolution2)
  {
    ZernikeSolution lSolution = mFactory.crossover(pSolution1,
                                                   pSolution2);
