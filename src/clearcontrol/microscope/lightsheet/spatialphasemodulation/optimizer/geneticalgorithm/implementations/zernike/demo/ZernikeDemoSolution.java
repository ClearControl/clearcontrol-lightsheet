...
public class ZernikeDemoSolution extends ZernikeSolution {
    ...
    ZernikeSolution mReference;

    public ZernikeDemoSolution(double[] pFactors, LightSheetMicroscope pLightSheetMicroscope, SpatialPhaseModulatorDeviceInterface pSpatialPhaseModulatorDeviceInterface, double pPositionZ, ZernikeSolution pReference) {
    ...
    public double fitness() {
        ...
        DenseMatrix64F lReferenceMatrix = mReference.getMatrix();
