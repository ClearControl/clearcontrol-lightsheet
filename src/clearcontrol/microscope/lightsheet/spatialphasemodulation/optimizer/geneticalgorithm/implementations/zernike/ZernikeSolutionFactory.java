...
/**
 * The ZernikeSolutionFactory generates potential solutions for finding a good
 * mirror shape
 *
 * Author: @haesleinhuepf 04 2018
 */
public class ZernikeSolutionFactory implements
                                    SolutionFactory<ZernikeSolution>
{
  ...
  public ZernikeSolutionFactory(LightSheetMicroscope pLightSheetMicroscope,
  ...
  public ZernikeSolution random()
  {
    ...
    {
      lFactors[i] = mRandom.nextDouble() * mRangeFactor * 2
                    - mRangeFactor;
    }

    return new ZernikeSolution(lFactors,
  ...
  @Override
  public ZernikeSolution crossover(ZernikeSolution pSolution1,
                                   ZernikeSolution pSolution2)
  {
    ...
    return new ZernikeSolution(lNewFactors,
                               mLightSheetMicroscope,
                               mSpatialPhaseModulatorDeviceInterface,
                               mPositionZ);
  }
