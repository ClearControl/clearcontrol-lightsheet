 ...
 */
public class ActuatorSolutionFactory implements
                                     SolutionFactory<ActuatorSolution>
{
  ...
  public ActuatorSolutionFactory(LightSheetMicroscope pLightSheetMicroscope,
  ...
  public ActuatorSolution random()
  {
    DenseMatrix64F lMatrix =
                           new DenseMatrix64F(mSpatialPhaseModulatorDeviceInterface.getMatrixWidth(),
                                              mSpatialPhaseModulatorDeviceInterface.getMatrixHeight());
    ...
    return new ActuatorSolution(lMatrix,
  ...
  @Override
  public ActuatorSolution crossover(ActuatorSolution pSolution1,
                                    ActuatorSolution pSolution2)
  {
    ...
    {
      for (int y =
                 lRandomPositionStartY; y <= lRandomPositionEndY; y++)
      {
        lNewMatrix.set(x, y, lMatrix2.get(x, y));
      }
    }

    return new ActuatorSolution(lNewMatrix,
                                mLightSheetMicroscope,
                                mSpatialPhaseModulatorDeviceInterface,
                                mPositionZ);
  }
