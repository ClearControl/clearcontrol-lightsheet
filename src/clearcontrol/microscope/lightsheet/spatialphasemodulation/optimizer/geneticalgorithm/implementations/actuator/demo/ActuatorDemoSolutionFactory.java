...
/**
 * The ActuatorDemoSolutionFactory allows to create ZernikeDemoSolutions which don't need a real microscope to calculate
 * fitness.
 *
 * Author: @haesleinhuepf
 * 04 2018
 */
public class ActuatorDemoSolutionFactory implements SolutionFactory<ActuatorDemoSolution> {
    ...
    public ActuatorDemoSolutionFactory(LightSheetMicroscope pLightSheetMicroscope, SpatialPhaseModulatorDeviceInterface pSpatialPhaseModulatorDeviceInterface, double pPositionZ, DenseMatrix64F pReferenceSolutionMatrix) {

        mFactory = new ActuatorSolutionFactory(pLightSheetMicroscope, pSpatialPhaseModulatorDeviceInterface, pPositionZ);
    ...
    public ActuatorDemoSolution random() {
        ...
        return new ActuatorDemoSolution(lSolution.getMatrix(), mLightSheetMicroscope, mSpatialPhaseModulatorDeviceInterface, mPositionZ, mReferenceSolutionMatrix);
    }


    @Override
    public ActuatorDemoSolution crossover(ActuatorDemoSolution pSolution1, ActuatorDemoSolution pSolution2) {
        ActuatorSolution lSolution = mFactory.crossover(pSolution1, pSolution2);
