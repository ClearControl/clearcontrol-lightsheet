...
/**
 * The ZernickeGeneticAlgorithmDemo sets a certain combination of Zernike modes as ground truth and asks a genetic
 * algorithm to find the same comination with random combinations as starting point.
 *
 * Author: @haesleinhuepf
 * 04 2018
 */
public class ZernickeGeneticAlgorithmDemo {
    public static void main(String... args) {
        ...
        ZernikeDemoSolutionFactory lSolutionFactory = new ZernikeDemoSolutionFactory(null, lDMSimulator, 160, 6, lReferenceSolution);
