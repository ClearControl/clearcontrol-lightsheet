 ...
 */
public class GeneticAlgorithmMirrorModeOptimizeInstruction extends
                                                           ...
                                                           PropertyIOableInstructionInterface
{
  ...
  private BoundedVariable<Integer> mNumberOfEpochsPerTimePoint =
                                                               new BoundedVariable<Integer>("Number of epochs per time point",
                                                                                            10,
                                                                                            0,
                                                                                            Integer.MAX_VALUE);
  private BoundedVariable<Integer> mPopulationSize =
                                                   new BoundedVariable<Integer>("Population size",
                                                                                10,
                                                                                0,
                                                                                Integer.MAX_VALUE);
  private BoundedVariable<Integer> mNumberOfMutations =
                                                      new BoundedVariable<Integer>("NumberOfMutations",
                                                                                   1,
                                                                                   0,
                                                                                   Integer.MAX_VALUE);
  ...
  private BoundedVariable<Double> mZernikeRangeFactor =
                                                      new BoundedVariable<Double>("Zernike range factor",
                                                                                  0.1,
                                                                                  0.0,
                                                                                  Double.MAX_VALUE,
                                                                                  0.0000001);
  ...
  public boolean initialize()
  {
    InterpolatedAcquisitionState lState =
                                        (InterpolatedAcquisitionState) getLightSheetMicroscope().getAcquisitionStateManager()
                                                                                                .getCurrentState();
    if (mPositionZ.get() < lState.getStackZLowVariable()
                                 .getMin()
                                 .doubleValue()
        || mPositionZ.get() > lState.getStackZLowVariable()
                                    .getMax()
                                    .doubleValue())
    {
      mPositionZ.set((lState.getStackZLowVariable()
                            .get()
                            .doubleValue()
    ...
    mPositionZ.setMinMax(lState.getStackZHighVariable()
                               .getMin()
                               .doubleValue(),
                         lState.getStackZHighVariable()
                               .getMax()
                               .doubleValue());
    ZernikeSolutionFactory lFactory =
                                    new ZernikeSolutionFactory(getLightSheetMicroscope(),
                                                               mMirror,
                                                               mPositionZ.get(),
                                                               6,
                                                               mZernikeRangeFactor.get());
    mPopulation =
                new Population<ZernikeSolution>(lFactory,
                                                mPopulationSize.get(),
                                                mNumberOfMutations.get());
  ...
  public boolean enqueue(long pTimePoint)
  {
    for (int e = 0; e < mNumberOfEpochsPerTimePoint.get(); e++)
    {
      ...
      if (getLightSheetMicroscope().getDevice(LightSheetTimelapse.class,
                                              0)
  ...
  {
    GeneticAlgorithmMirrorModeOptimizeInstruction copied =
                                                         new GeneticAlgorithmMirrorModeOptimizeInstruction(mMirror,
