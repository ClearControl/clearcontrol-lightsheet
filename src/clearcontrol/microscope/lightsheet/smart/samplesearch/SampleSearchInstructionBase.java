                                                  ...
                                                  LightSheetMicroscopeInstructionBase
{
  ...
  protected BoundedVariable<Double> mStepSizeInMillimetersVariable =
  ...
  protected ArrayList<Double> measureAverageSignalIntensityAtCandiatePositions()
  {
    ArrayList<Position> lSampleCandidatePositionList =
                                                     mSampleCandidates.getTravelPathList();
    ...
    for (int i = 0; i < lSampleCandidatePositionList.size(); i++)
    {
                                    ...
                                    new SingleViewPlaneImager(getLightSheetMicroscope(),
                                                              (lState.getStackZLowVariable()
                                                               ...
                                                               + lState.getStackZHighVariable()
                                                                       .getMax()
                                                                       .doubleValue()) / 2.0);
      lImager.setImageHeight(lState.getImageWidthVariable()
                                   .get()
                                   .intValue());
      lImager.setImageHeight(lState.getImageHeightVariable()
                                   .get()
                                   .intValue());
      lImager.setExposureTimeInSeconds(lState.getExposureInSecondsVariable()
                                             .get()
                                             .doubleValue());
      ...
      lCLImage.close();
      double average = sum / (lState.getImageWidthVariable()
                                    .get()
                                    .intValue()
                              * lState.getImageHeightVariable()
                                      .get()
                                      .intValue());
