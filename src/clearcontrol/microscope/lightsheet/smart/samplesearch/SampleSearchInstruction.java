 ...
 * 05 2018
 */
public abstract class SampleSearchInstruction extends InstructionBase {
     ...
     */
    public SampleSearchInstruction(String pDeviceName) {
        super(pDeviceName);
    }
    ...
    public boolean initialize() {
        ...
        mSampleCandidates = new SpaceTravelInstruction();
