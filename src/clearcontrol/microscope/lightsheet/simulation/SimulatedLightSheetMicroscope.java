    ...
    if (multiview)
    {
      ...
      addDevice(0,
                new WriteFusedImageAsRawToDiscInstruction("interleaved",
                                                          this));
      addDevice(0,
                new WriteFusedImageAsTifToDiscInstructionBase("interleaved",
                                                              this));
      addDevice(0,
      ...
      addDevice(0,
                new WriteFusedImageAsTifToDiscInstructionBase("sequential",
                                                              this));
      ...
      addDevice(0,
                new WriteFusedImageAsRawToDiscInstruction("opticsprefused",
                                                          this));
      addDevice(0,
                new WriteFusedImageAsTifToDiscInstructionBase("opticsprefused",
                                                              this));
      addDevice(0,
