                                        ...
                                        implements LoggingFeature
{
...

    {
...

      {
        ...
        lCloneButton.setOnAction((e) -> {
          ...
          if (lSelectedIndex > -1)
          {
            lSchedulerList.add(lSelectedIndex,
                               lSchedulerList.get(lSelectedIndex)
                                             .copy());
          }
          mCurrentProgramScheduleListView.setItems(FXCollections.observableArrayList(lSchedulerList));
          refreshPropertiesScrollPane();
      ...
      lRow = 7;
      {
        ...
        TreeItem<String> rootItem =
                                  buildInstructionTree(pLightSheetTimelapse,
                                                       lFilters,
                                                       "",
                                                       lIcons);
        ...
        lSchedulerChecklistGridPane.setOnKeyReleased((e) -> {
          info("keyreleased");
          tree.setRoot(buildInstructionTree(mLightSheetTimelapse,
                                            lFilters,
            ...
            if (mouseEvent.getClickCount() == 2)
            {
                         ...
                         .compareTo("Instructions") != 0)
              {
                ...
                if (lSelectedIndexInMainList < 0)
                  lSelectedIndexInMainList = lSchedulerList.size();
                lSchedulerList.add(lSelectedIndexInMainList,
                                   pLightSheetTimelapse.getListOfAvailableSchedulers(item.getParent()
                                                                                         .getValue()
                                                                                     + ":"
                                                                                     + item.getValue())
                                                       .get(0)
  ...
  private void refreshPropertiesScrollPane()
  {
                                       ...
                                       .getSelectedIndex() > -1)
    {
      InstructionInterface lInstruction =
                                        lSchedulerList.get(mCurrentProgramScheduleListView.getSelectionModel()
                                                                                          .getSelectedIndex());
  ...
  @NotNull
  private TreeItem<String> buildInstructionTree(LightSheetTimelapse pLightSheetTimelapse,
                                                String[] lFilters,
                                                ...
                                                Node[] lIcons)
  {
    ...
    for (int i = 0; i < lFilters.length; i++)
    {
      ArrayList<InstructionInterface> lAvailableSchedulersList =
                                                               pLightSheetTimelapse.getListOfAvailableSchedulers(lFilters[i],
                                                                                                                 pSearchFilter);
