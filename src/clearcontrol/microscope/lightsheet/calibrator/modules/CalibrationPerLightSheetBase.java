 ...
 */
public class CalibrationPerLightSheetBase extends CalibrationBase
                                          implements
                                          HasConfigurationStatePerLightSheet
{
  ...
  public CalibrationPerLightSheetBase(String pName,
  ...
  public void addConfigurationStateChangeListener(ConfigurationStateChangeListener pConfigurationStateChangeListener)
  {
                              ...
                              0; lLightSheetIndex < getLightSheetMicroscope().getNumberOfLightSheets(); lLightSheetIndex++)
    {
      setConfigurationState(lLightSheetIndex,
                            getConfigurationState(lLightSheetIndex));
    }
