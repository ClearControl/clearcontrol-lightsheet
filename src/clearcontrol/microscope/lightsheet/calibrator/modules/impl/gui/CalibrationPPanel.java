...
public class CalibrationPPanel extends StandardCalibrationModulePanel
{
  public CalibrationPPanel(CalibrationP pCalibrationP)
  {
    ...
    addNumberTextFieldForVariable(pCalibrationP.getNumberOfSamplesVariable()
                                               .getName(),
                                  pCalibrationP.getNumberOfSamplesVariable());
    addNumberTextFieldForVariable(pCalibrationP.getDetectionArmVariable()
                                               .getName(),
    ...
    addNumberTextFieldForVariable(pCalibrationP.getMaxIterationsVariable()
                                               .getName(),
