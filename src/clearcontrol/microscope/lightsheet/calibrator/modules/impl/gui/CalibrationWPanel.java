...
public class CalibrationWPanel extends StandardCalibrationModulePanel
{
  public CalibrationWPanel(CalibrationW pCalibrationW)
  {
    ...
    addNumberTextFieldForVariable(pCalibrationW.getNumberOfSamplesVariable()
                                               .getName(),
                                  pCalibrationW.getNumberOfSamplesVariable());
    addNumberTextFieldForVariable(pCalibrationW.getDetectionArmVariable()
                                               .getName(),
                                  pCalibrationW.getDetectionArmVariable());
  }
}
