 ...
 */
public class CalibrationZWithSamplePanel extends
                                         StandardCalibrationModulePanel
{
  public CalibrationZWithSamplePanel(CalibrationZWithSample pCalibrationZWithSample)
  {
    super(pCalibrationZWithSample);

    addNumberTextFieldForVariable(pCalibrationZWithSample.getNumberOfISamples()
                                                         .getName(),
                                  pCalibrationZWithSample.getNumberOfISamples());
    addNumberTextFieldForVariable(pCalibrationZWithSample.getNumberOfDSamples()
                                                         .getName(),
    ...
    addNumberTextFieldForVariable(pCalibrationZWithSample.getMaxDeltaZ()
                                                         .getName(),
