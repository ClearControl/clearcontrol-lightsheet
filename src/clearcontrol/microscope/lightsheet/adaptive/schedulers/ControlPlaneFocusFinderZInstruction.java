                                                               ...
                                                               LoggingFeature
{
  ...
  public ControlPlaneFocusFinderZInstruction(int pDetectionArmIndex, int pControlPlaneIndex)
  {
    ...
    if (mMicroscope instanceof LightSheetMicroscope)
    {
      ...
      for (int lLightSheetIndex = 0; lLightSheetIndex < lLightSheetMicroscope.getNumberOfLightSheets(); lLightSheetIndex++)
      {
        FocusFinderZInstruction
            lFocusFinder = new FocusFinderZInstruction(lLightSheetIndex, mDetectionArmIndex, mControlPlaneIndex);
