 ...
 * March 2018
 */
public class FocusFinderZScheduler extends SchedulerBase implements
                                                         SchedulerInterface,
                                                         LoggingFeature
{
  ...
  public FocusFinderZScheduler(int pLightSheetIndex, int pDetectionArmIndex, int pControlPlaneIndex) {
    super("Adaptation: Focus finder Z for C" + pDetectionArmIndex + "L" + pLightSheetIndex + "CPI" + pControlPlaneIndex);
  ...
  private double determineBestDeltaZAtZ(double lCPPositionZ, int lLightSheetIndex, int lCameraIdx) {
    ...
    InterpolatedAcquisitionState lInterpolatedAcquisitionState =
        (InterpolatedAcquisitionState) mLightSheetMicroscope.getAcquisitionStateManager().getCurrentState();
