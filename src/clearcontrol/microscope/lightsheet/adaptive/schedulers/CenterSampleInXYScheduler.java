...
public class CenterSampleInXYScheduler extends
    ...
    public boolean enqueue(long l) {
        ...
        //SingleViewAcquisitionScheduler lImage = mLightSheetMicroscope.getDevice(SingleViewAcquisitionScheduler.class, 0);
