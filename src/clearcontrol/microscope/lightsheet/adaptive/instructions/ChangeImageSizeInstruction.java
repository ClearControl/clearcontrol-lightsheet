 ...
 */
public class ChangeImageSizeInstruction extends
                                        LightSheetMicroscopeInstructionBase
                                        implements
                                        PropertyIOableInstructionInterface
{

  private BoundedVariable<Integer> imageWidth =
                                              new BoundedVariable<Integer>("Width in pixels",
                                                                           1024,
                                                                           1,
                                                                           Integer.MAX_VALUE);
  private BoundedVariable<Integer> imageHeight =
                                               new BoundedVariable<Integer>("Height in pixels",
                                                                            2048,
                                                                            1,
                                                                            Integer.MAX_VALUE);
  ...
  {
    ChangeImageSizeInstruction copied =
                                      new ChangeImageSizeInstruction(getLightSheetMicroscope());
