...
public class FocusFinderZInstructionPanel extends CustomGridPane
{
  public FocusFinderZInstructionPanel(FocusFinderZInstruction pFocusFinderZScheduler)
  {
    ...
    addIntegerField(pFocusFinderZScheduler.getNumberOfImagesToTakeVariable(),
                    1);
    addDoubleField(pFocusFinderZScheduler.getExposureTimeInSecondsVariable(),
                   2);
    addIntegerField(pFocusFinderZScheduler.getImageWidthVariable(),
                    3);
    addIntegerField(pFocusFinderZScheduler.getImageHeightVariable(),
                    4);
