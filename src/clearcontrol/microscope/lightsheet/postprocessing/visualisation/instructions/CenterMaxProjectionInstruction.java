 ...
 */
public class CenterMaxProjectionInstruction<T extends StackInterfaceContainer>
                                           extends
                                           ...
                                           PropertyIOableInstructionInterface
{
  ...
  private BoundedVariable<Integer> mFontSizeVariable =
                                                     new BoundedVariable<Integer>("Font size",
                                                                                  ...
                                                                                  5,
                                                                                  Integer.MAX_VALUE);
  private BoundedVariable<Integer> mStartZPlaneIndex =
                                                     new BoundedVariable<Integer>("Start Z plane index",
                                                                                  0,
                                                                                  0,
                                                                                  Integer.MAX_VALUE);
   ...
   *
   */
  public CenterMaxProjectionInstruction(Class<T> pClass,
                                        LightSheetMicroscope pLightSheetMicroscope)
  {
    super("Post-processing: Thumbnail (center max projection) generator for "
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    if (lStack.getMetaData() != null)
    {
      ...
      String foldername = targetFolder + "/stacks/"
                          + folderName
                          + "_"
                          + mStartZPlaneIndex.get()
                          + "_"
                          + mEndZPlaneIndex.get()
                          + "_text/";
      ...
      IJ.saveAsTiff(lResultImagePlus,
                    foldername + String.format("%0" + lDigits
                                               + "d",
                                               lTimePoint)
                                      + ".tif");
    }
  ...
  {
    CenterMaxProjectionInstruction copied =
                                          new CenterMaxProjectionInstruction(mClass,
