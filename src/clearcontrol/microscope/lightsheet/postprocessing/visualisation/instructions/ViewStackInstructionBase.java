 ...
 */
public abstract class ViewStackInstructionBase<T extends StackInterfaceContainer>
                                              extends
                                              ...
                                              PropertyIOableInstructionInterface
{
   ...
   *
   */
  public ViewStackInstructionBase(String pName,
                                  Class<T> pContainerStackInterfaceClass,
  ...
  private Variable<String> mImageContainerKeyMustContain =
                                                         new Variable<String>("Image key",
                                                                              "");

  protected StackInterface getImageFromContainer(StackInterfaceContainer lContainer)
  {
    String lImageContainerKey =
                              lContainer.getKeyContainingString(mImageContainerKeyMustContain.get()
                                                                                             .toLowerCase());
