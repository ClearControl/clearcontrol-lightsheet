 ...
 * April 2018
 */
public class MaxProjectionScheduler<T extends StackInterfaceContainer> extends SchedulerBase implements LoggingFeature {
     ...
     *
     */
    public MaxProjectionScheduler(Class<T> pClass) {
