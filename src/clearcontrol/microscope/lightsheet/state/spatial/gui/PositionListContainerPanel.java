  ...
  public PositionListContainerPanel(PositionListContainer pPositionListContainer)
  {
...

    {
      ...
      lMinusButton.setOnAction((e) -> {
        int count = 0;
        int lSelectedIndex = lListView.getSelectionModel()
                                      .getSelectedIndex();
    ...
    BoundedVariable<Double> lPositionX =
                                       new BoundedVariable<Double>("X",
                                                                   0.0,
                                                                   -Double.MAX_VALUE,
                                                                   Double.MAX_VALUE,
                                                                   0.0001);
    BoundedVariable<Double> lPositionY =
                                       new BoundedVariable<Double>("Y",
                                                                   0.0,
                                                                   -Double.MAX_VALUE,
                                                                   Double.MAX_VALUE,
                                                                   0.0001);
    BoundedVariable<Double> lPositionZ =
    ...
    addDoubleField(lPositionZ, mRow);
    {
      ...
      lManualAddPosition.setOnAction((e) -> {
        ...
        lTravelPathList.add(lSelectedIndexInMainList,
                            new Position(lPositionX.get(),
                                         lPositionY.get(),
                                         lPositionZ.get()));
        lListView.setItems(FXCollections.observableArrayList(lTravelPathList));
      });
