 ...
 * 09 2018
 */
public class AcquisitionStateSolutionFactory implements SolutionFactory<AcquisitionStateSolution> {
    ...
    public AcquisitionStateSolution random() {
        return new AcquisitionStateSolution(startSolution.state, startSolution.stepState);
    }

    @Override
    public AcquisitionStateSolution crossover(AcquisitionStateSolution pSolution1, AcquisitionStateSolution pSolution2) {

        AcquisitionStateSolution result = new AcquisitionStateSolution(pSolution1.state, startSolution.stepState);
