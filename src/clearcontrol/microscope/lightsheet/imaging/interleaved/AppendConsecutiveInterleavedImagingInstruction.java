...
/**
 * The AppendConsecutiveInterleavedImagingInstruction appends a list of imaging,
 * fusion and io instructions at the current position in the timelapse
 *
 * Author: @haesleinhuepf 05 2018
 */
public class AppendConsecutiveInterleavedImagingInstruction extends
                                                            ...
                                                            PropertyIOableInstructionInterface
{
   ...
   *
   */
  public AppendConsecutiveInterleavedImagingInstruction(int pNumberOfImages,
                                                        double pIntervalInSeconds,
                                                        LightSheetMicroscope pLightSheetMicroscope)
  {
    super("Smart: Append an interleaved scan with " + pNumberOfImages
          + " images every "
          + pIntervalInSeconds
  ...
  {
    String timeMeasurementKey = "interleaved_"
    ...
    for (int i = 0; i < mNumberOfImages.get(); i++)
    {
      ...
      index++;
      schedule.add(index,
                   new InterleavedAcquisitionInstruction(getLightSheetMicroscope()));
      index++;
      schedule.add(index,
                   new InterleavedFusionInstruction(getLightSheetMicroscope()));
      index++;
      schedule.add(index,
  ...
  {
    return new AppendConsecutiveInterleavedImagingInstruction(mNumberOfImages.get(),
