 ...
 */
public class AppendConsecutiveHyperDriveImagingInstruction extends
                                                           ...
                                                           PropertyIOableInstructionInterface
{
   ...
   *
   */
  public AppendConsecutiveHyperDriveImagingInstruction(int pNumberOfImages,
                                                       double pIntervalInSeconds,
                                                       LightSheetMicroscope pLightSheetMicroscope)
  {
    super("Smart: Append a HyperDrive scan with " + pNumberOfImages
          + " images every "
          + pIntervalInSeconds
  ...
  {
    return new AppendConsecutiveHyperDriveImagingInstruction(mNumberOfImages.get(),
