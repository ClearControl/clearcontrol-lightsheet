...
/**
 * AppendConsecutiveOpticsPrefusedImagingInstruction appends a list of imaging,
 * fusion and io instructions at the current position in the timelapse
 *
 * Author: @haesleinhuepf 05 2018
 */
public class AppendConsecutiveOpticsPrefusedImagingInstruction extends
                                                               ...
                                                               PropertyIOableInstructionInterface
{
   ...
   *
   */
  public AppendConsecutiveOpticsPrefusedImagingInstruction(int pNumberOfImages,
                                                           double pIntervalInSeconds,
                                                           LightSheetMicroscope pLightSheetMicroscope)
  {
    super("Smart: Append an optics-prefused scan with "
          + pNumberOfImages
          + " images every "
          + pIntervalInSeconds
  ...
  {
    String timeMeasurementKey = "opticsprefused_"
  ...
  {
    return new AppendConsecutiveOpticsPrefusedImagingInstruction(mNumberOfImages.get(),
  ...
  {
    return new Variable[]
    { getIntervalInSeconds(), getNumberOfImages() };
  }
}
