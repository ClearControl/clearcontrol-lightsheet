...
/**
 * AppendConsecutiveSequentialImagingInstruction appends a list of imaging,
 * fusion and io instructions at the current position in the timelapse
 *
 * Author: @haesleinhuepf 05 2018
 */
public class AppendConsecutiveSequentialImagingInstruction extends
                                                           ...
                                                           PropertyIOableInstructionInterface
{
   ...
   *
   */
  public AppendConsecutiveSequentialImagingInstruction(int pNumberOfImages,
                                                       double pIntervalInSeconds,
                                                       LightSheetMicroscope pLightSheetMicroscope)
  {
    super("Smart: Append a sequential scan with " + pNumberOfImages
          + " images every "
          + pIntervalInSeconds
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    for (int i = 0; i < mNumberOfImages.get(); i++)
    {
      ...
      index++;
      schedule.add(index,
                   new SequentialAcquisitionInstruction(getLightSheetMicroscope()));
      index++;
      schedule.add(index,
                   new SequentialFusionInstruction(getLightSheetMicroscope()));
      index++;
      schedule.add(index,
  ...
  {
    return new AppendConsecutiveSequentialImagingInstruction(mNumberOfImages.get(),
