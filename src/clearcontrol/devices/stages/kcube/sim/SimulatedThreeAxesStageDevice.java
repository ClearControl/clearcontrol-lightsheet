 ...
 */
public class SimulatedThreeAxesStageDevice extends VirtualDevice
                                           implements
                                           ...
                                           LoggingFeature
{
  ...
  @Override
  public boolean moveXBy(double pDistance, boolean pWaitToFinish)
  {
    sleep();
  ...
  @Override
  public boolean moveYBy(double pDistance, boolean pWaitToFinish)
  {
    sleep();
  ...
  @Override
  public boolean moveZBy(double pDistance, boolean pWaitToFinish)
  {
    sleep();
