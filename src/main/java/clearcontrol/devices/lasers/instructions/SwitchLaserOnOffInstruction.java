 ...
 */
public class SwitchLaserOnOffInstruction extends InstructionBase
                                         implements
                                         ...
                                         LoggingFeature
{
  ...
  public SwitchLaserOnOffInstruction(LaserDeviceInterface pLaserDevice,
                                     boolean pTurnOn)
  {
    super("Laser: Switch " + pLaserDevice.getName()
          + " "
          + (pTurnOn ? "ON" : "OFF"));
  ...
  public String getDescription() {
    return "Switch a laser on or off.";
  }
}
