...
public class KCubePane extends CustomGridPane
{
  ...
  public KCubePane(KCubeDevice pKCubeDevice)
  {
    ...
    // BoundedVariable<Double > lPositionVariable = new
    // BoundedVariable<Double>(mKCubeDevice.getName(),
    // mKCubeDevice.getCurrentPosition(), mKCubeDevice.getMinPosition(),
    // mKCubeDevice.getMaxPosition(), 0.0001);
