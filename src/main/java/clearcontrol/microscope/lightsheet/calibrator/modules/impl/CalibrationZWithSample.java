...
/**
 * This is a fork of CalibrationZ goal of the test is to determine if
 * calibration Z with sample makes sense / works. If yes: TODO: Remove code
 * duplication and clean up all calibraiton modules
 *
 *
 * @author royer Author: Robert Haase (http://haesleinhuepf.net) at MPI CBG
 *         (http://mpi-cbg.de) December 2017
 */
public class CalibrationZWithSample extends
                                    CalibrationPerLightSheetBase
                                    implements
                                    ...
                                    HasStateDescriptionPerLightSheet
{
   ...
   *          calibrator
   */
  public CalibrationZWithSample(CalibrationEngine pCalibrator)
  {
    super("ZwS", pCalibrator);
                            ...
                            boolean pAdjustDetectionZ)
  {
    ...
    double lMinDZ = lInterpolatedAcquisitionState.getControlPlaneZ(0); // Double.NEGATIVE_INFINITY;
    double lMaxDZ =
                  lInterpolatedAcquisitionState.getControlPlaneZ(lInterpolatedAcquisitionState.getNumberOfControlPlanes()
