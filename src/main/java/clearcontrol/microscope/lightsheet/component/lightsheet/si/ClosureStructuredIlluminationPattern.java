 ...
 * 
 * Convenience structured illumination pattern that can be defined with a
 * closure (functional interface)
 * 
 *
 * @author royer
 */
                                                  ...
                                                  StructuredIlluminationPatternInterface
{
  ...
  /**
   * Instantiates a closure-defined structure illumination pattern given a
   * stepping function and number of phases.
   * 
   * @param pSteppingFunction
   *          stepping function
   * @param pNumberOfPhases
   *          number of phases
   */
