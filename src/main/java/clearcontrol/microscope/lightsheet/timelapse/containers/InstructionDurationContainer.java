...
/**
 * The InstructionDurationContainer is used to store a time to the warehouse.
 * The idea is doing statistics: After some instructions have been executed and
 * their duration was saved, it might be possible to predict how long
 * instructions might take in the future.
 *
...
public class InstructionDurationContainer extends MeasurementContainer
{
  ...
  public InstructionDurationContainer(long pTimePoint,
                                      InstructionInterface pInstructionInterface,
                                      double pDurationInMilliseconds)
  {
