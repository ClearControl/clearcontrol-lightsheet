...
/**
 * The WriteSpecificStackToSpecificRawFolderInstruction gets the oldest
 * container of a given class from the warehouse and saves a specified stack
 * from it to disc.
 *
                                                              ...
                                                              PropertyIOableInstructionInterface
{
  ...
  Variable<String> mSourceStackKeyVariable =
                                           new Variable<String>("Stack key to save",
                                                                "C0L0");
  Variable<String> mTargetRawFolderNameVariable =
                                                new Variable<String>("Foldername",
                                                                     "C0L0");

  /**
   *
   * @param pSourceStackKey
   *          which stack should be saved
   * @param pTargetRawFolderName
   *          under which name should the stack be saved
   * @param pLightSheetMicroscope
   */
  public WriteSpecificStackToSpecificRawFolderInstruction(String pSourceStackKey,
                                                          String pTargetRawFolderName,
                                                          LightSheetMicroscope pLightSheetMicroscope)
  {
    super("IO: Write '" + pSourceStackKey
          + "' as '"
          + pTargetRawFolderName
          + "' RAW folder ot disc",
          StackInterfaceContainer.class,
          new String[]
    { pSourceStackKey }, pTargetRawFolderName, pLightSheetMicroscope);
  ...
  {
    return new WriteSpecificStackToSpecificRawFolderInstruction(mSourceStackKeyVariable.get(),
                                                                mTargetRawFolderNameVariable.get(),
  ...
  {
    return "IO: Write '" + mSourceStackKeyVariable.get()
           + "' as '"
           + mTargetRawFolderNameVariable.get()
           + "' RAW folder ot disc";
  }
