...
/**
 * This instructions writes the raw data from the single view acquisition stored
                                                              ...
                                                              WriteStackInterfaceContainerAsRawToDiscInstructionBase
{
   ...
   *
   */
  public WriteSingleLightSheetImageAsRawToDiscInstruction(int pDetectionArmIndex,
