...
public class InterpolatedAcquisitionStateData
{
  ...
  /**
   * This constructor is needed for file I/O it should not be used by the
   * programmer
   */
  @Deprecated
  ...
  public InterpolatedAcquisitionStateData(InterpolatedAcquisitionState pState)
  {
    ...
    for (int d = 0; d < pState.getNumberOfDetectionArms(); d++)
    {
      ...
      for (int cpi =
                   0; cpi < pState.getNumberOfControlPlanes(); cpi++)
      {
    ...
    {
      mIlluminationX[l] =
                        new Double[pState.getNumberOfControlPlanes()];
      mIlluminationY[l] =
                        new Double[pState.getNumberOfControlPlanes()];
      mIlluminationZ[l] =
                        new Double[pState.getNumberOfControlPlanes()];
      ...
      for (int cpi =
                   0; cpi < pState.getNumberOfControlPlanes(); cpi++)
      {
        mIlluminationX[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IX, cpi, l);
        mIlluminationY[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IY, cpi, l);
        mIlluminationZ[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IZ, cpi, l);
        mIlluminationA[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IA, cpi, l);
        mIlluminationB[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IB, cpi, l);
        mIlluminationW[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IW, cpi, l);
        mIlluminationH[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IH, cpi, l);
        mIlluminationP[l][cpi] = pState.getInterpolationTables()
                                       .get(LightSheetDOF.IP, cpi, l);
      }
    }
  }
