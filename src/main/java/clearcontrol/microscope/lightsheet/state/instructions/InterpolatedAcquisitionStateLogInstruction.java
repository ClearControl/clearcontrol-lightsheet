...
/**
 * This instructions writes the current acquisition state to a file with the
 * timepoint being part of the filename
 *
 * Author: Robert Haase (http://haesleinhuepf.net) at MPI CBG
 * (http://mpi-cbg.de) April 2018
 */
public class InterpolatedAcquisitionStateLogInstruction extends
                                                        ...
                                                        LoggingFeature
{
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    File tempFile = new File(lTimelapse.getWorkingDirectory(),
                             "state_t" + pTimePoint + ".acqstate");
