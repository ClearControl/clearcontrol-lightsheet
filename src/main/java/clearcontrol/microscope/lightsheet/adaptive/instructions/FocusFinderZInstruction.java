...
/**
 * This instructions initializes focus (delta Z of illumination arms). It should
 * be used if the focus is really off.
 *
 * Author: Robert Haase (http://haesleinhuepf.net) at MPI CBG
 * (http://mpi-cbg.de) March 2018
 */
public class FocusFinderZInstruction extends
                                     ...
                                     PropertyIOableInstructionInterface
{
  ...
  private BoundedVariable<Integer> mNumberOfImagesToTakeVariable =
                                                                 new BoundedVariable<Integer>("number of samples",
                                                                                              ...
                                                                                              1000,
                                                                                              1);
  private BoundedVariable<Double> mDeltaZVariable =
                                                  new BoundedVariable<Double>("deltaZ",
                                                                              1.0,
                                                                              0.01,
                                                                              Double.MAX_VALUE,
                                                                              0.01);
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    double deltaZ = -determineBestDeltaZAtZ(lCPPositionZ,
                                            lLightSheetIndex,
                                            lCameraIdx);
                                        ...
                                        int lCameraIdx)
  {
    ...
    double lDetectionZZStart = lIlluminationZStart
                               - (lDetectionZStep
    ...
    for (int illuminationZIndex =
                                0; illuminationZIndex < lNumberOfImagesToTake; illuminationZIndex++)
    {
      lInterpolatedAcquisitionState.applyAcquisitionStateAtZ(lQueue,
                                                             lIlluminationZStart);
      for (int l =
      ...
      double lPositionZ = lDetectionZZStart
                          + illuminationZIndex * lDetectionZStep;
      ...
      {
        lQueue.setDZ(lDetectionArmIndex,
                     lQueue.getDZ(lDetectionArmIndex) + lPositionZ);
      }
  ...
  */
  ...
  {
    FocusFinderZInstruction copied =
