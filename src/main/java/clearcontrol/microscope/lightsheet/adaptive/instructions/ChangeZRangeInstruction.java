 ...
 */
public class ChangeZRangeInstruction extends
                                     LightSheetMicroscopeInstructionBase
                                     implements
                                     PropertyIOableInstructionInterface
{

  private BoundedVariable<Double> minZ =
                                       new BoundedVariable<Double>("Start Z in microns",
                                                                   0.0,
                                                                   -Double.MAX_VALUE,
                                                                   Double.MAX_VALUE,
                                                                   0.001);
  private BoundedVariable<Double> maxZ =
                                       new BoundedVariable<Double>("End Z in microns",
                                                                   320.0,
                                                                   -Double.MAX_VALUE,
                                                                   Double.MAX_VALUE,
                                                                   0.001);
  private BoundedVariable<Double> stepZ =
                                        new BoundedVariable<Double>("Step Z in microns",
                                                                    2.5,
                                                                    -Double.MAX_VALUE,
                                                                    Double.MAX_VALUE,
                                                                    0.001);
  ...
  {
    ChangeZRangeInstruction copied =
                                   new ChangeZRangeInstruction(getLightSheetMicroscope());
