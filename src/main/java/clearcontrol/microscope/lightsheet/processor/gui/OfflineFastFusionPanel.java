...
public class OfflineFastFusionPanel extends CustomGridPane
{
  ...
  public OfflineFastFusionPanel(OfflineFastFusionEngine pOfflineFastFusionEngine)
  {

    int lRow = 0;
    {
      SimpleIndicator lOfflineFusionStateIndicator =
                                                   new SimpleIndicator();
      lOfflineFusionStateIndicator.indicatorStyleProperty()
                                  .set(SimpleIndicator.IndicatorStyle.RED);
      pOfflineFastFusionEngine.getIsRunningVariable()
                              .addSetListener((o, n) -> {
                                lOfflineFusionStateIndicator.onProperty()
                                                            .set(n);
                              });
    ...
    {
      CustomVariablePane lCustomVariablePane =
                                             new CustomVariablePane();

      lCustomVariablePane.addTab("Configuration");

      lCustomVariablePane.addNumberTextFieldForVariable(pOfflineFastFusionEngine.getFirstTimePointToFuse()
                                                                                .getName(),
      ...
      lCustomVariablePane.addNumberTextFieldForVariable(pOfflineFastFusionEngine.getLastTimePointToFuse()
                                                                                .getName(),
      ...
      lCustomVariablePane.addCheckBoxForVariable("Background subtraction",
                                                 pOfflineFastFusionEngine.getBackgroundSubtractionSwitchVariable());

      lCustomVariablePane.addCheckBoxForVariable("Downscaling by 2 in X/Y",
                                                 pOfflineFastFusionEngine.getDownscaleSwitchVariable());

      lCustomVariablePane.addCheckBoxForVariable("Registration",
                                                 pOfflineFastFusionEngine.getRegistrationSwitchVariable());
