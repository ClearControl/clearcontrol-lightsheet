 ...
 */
public class SliceBySliceMeasurementContainer extends
                                              DataContainerBase
{
  ...
  public SliceBySliceMeasurementContainer(long pTimePoint,
                                          double[] pMeasurements)
  {
    super(pTimePoint);
    mMeasurements = new double[pMeasurements.length];
    System.arraycopy(pMeasurements,
                     0,
                     mMeasurements,
                     0,
  ...
  public double[] getMeasurements()
  {
    ...
    System.arraycopy(mMeasurements,
                     0,
                     lMeasurements,
                     0,
                     mMeasurements.length);
